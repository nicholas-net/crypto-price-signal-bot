    ...
    try:
        while True:
            ...
            def price_signal(curr_time: dt.datetime, curr_price: float) -> None:
                ...
                Prints out a notification on the desktop to alert of any extreme price dipping.
                ...
                target_time = curr_time - timedelta(hours=24) # The target represents the timestamp closest to 24 hours ago.
